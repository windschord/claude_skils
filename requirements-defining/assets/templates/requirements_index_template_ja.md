...
|----|---------|--------|-----------|------------|
| US-001 | [ストーリータイトル] | 高/中/低 | 作成中/レビュー中/承認済 | [詳細](stories/US-001.md) |
| US-002 | [ストーリータイトル] | 高/中/低 | 作成中/レビュー中/承認済 | [詳細](stories/US-002.md) |
...
| カテゴリ | 詳細リンク | 要件数 |
|----------|------------|--------|
| 性能要件 | [詳細](nfr/performance.md) | X件 |
| セキュリティ要件 | [詳細](nfr/security.md) | X件 |
| ユーザビリティ要件 | [詳細](nfr/usability.md) | X件 |
