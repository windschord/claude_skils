---
name: depth-interview-career
description: キャリア設計のためのデプスインタビューを実施します。表面的な希望ではなく、本人の価値観・強み・動機を引き出し、すべての会話をファイルに記録します。5 Whys、ラダリング法などの手法を用いて、キャリアビジョンの明確化を支援します。
---
