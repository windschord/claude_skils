...
| 重大度 | 条件 |
|--------|------|
| critical | API仕様と実装が矛盾し、クライアントが動作しない |
| warning | ドキュメントと実装の不一致（動作には影響しないが誤解を招く） |
| suggestion | ドキュメントの追加・更新が望ましい |
| nitpick | コメントの誤字・表現の改善 |
...
- **セキュリティ**: 既知の脆弱性の履歴、セキュリティアドバイザリの対応速度
