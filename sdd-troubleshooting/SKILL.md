...
```text
エージェントチームを作成して、以下のバグを並列調査してください。
各チームメンバーには異なる仮説を割り当て、互いに発見を共有して
仮説を検証・反証するよう指示してください。

問題: [問題の概要]
再現手順: [再現手順]

仮説と担当:
- 調査員1: [仮説1の説明] - [調査対象ファイル/ディレクトリ]
- 調査員2: [仮説2の説明] - [調査対象ファイル/ディレクトリ]
- 調査員3: [仮説3の説明] - [調査対象ファイル/ディレクトリ]

各調査員は:
1. 自分の仮説を裏付ける証拠を探す
2. 他の調査員の仮説を反証する証拠も探す
3. 発見をリーダーとチームメンバーに共有する
4. 調査結果をまとめてリーダーに報告する

リーダーは調査結果を統合し、最も有力な根本原因を特定してください。
```
