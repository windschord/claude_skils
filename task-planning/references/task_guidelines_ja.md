...
- [AIエージェント向けタスク設計の原則](#aiエージェント向けタスク設計の原則)
  - [1. 具体性の原則](#1.-具体性の原則)
  - [2. 情報の完全性](#2.-情報の完全性)
  - [3. 推測禁止の原則](#3.-推測禁止の原則)
- [タスク粒度の詳細ガイド](#タスク粒度の詳細ガイド)
  - [シンプルな実装（10-20分）](#シンプルな実装（10-20分）)
  - [標準的な実装（20-40分）](#標準的な実装（20-40分）)
  - [複雑な実装（40-90分）](#複雑な実装（40-90分）)
- [ステータス管理](#ステータス管理)
  - [ステータス定義](#ステータス定義)
  - [ステータス遷移図](#ステータス遷移図)
- [依存関係の記述](#依存関係の記述)
  - [依存関係の種類](#依存関係の種類)
- [リスク管理](#リスク管理)
  - [リスク評価マトリクス](#リスク評価マトリクス)
  - [リスク記述例](#リスク記述例)
  - [リスク1: 外部API応答遅延](#リスク1:-外部api応答遅延)
  - [リスク2: 既存コードとの互換性問題](#リスク2:-既存コードとの互換性問題)
- [見積もりの補正](#見積もりの補正)
  - [補正係数](#補正係数)
  - [見積もり例](#見積もり例)
- [受入基準の書き方](#受入基準の書き方)
