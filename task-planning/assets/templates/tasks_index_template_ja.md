...
|---------|------|--------|--------|----------|-----------|
| Phase 1: 基盤構築 | 0 | 0 | 2 | 0 | [詳細](phase-1/) @phase-1/ |
| Phase 2: コア機能 | 0 | 0 | 2 | 0 | [詳細](phase-2/) @phase-2/ |
| Phase 3: 統合・テスト | 0 | 0 | 1 | 0 | [詳細](phase-3/) @phase-3/ |
...
|----------|---------|-----------|------|------|-----------|
| TASK-001 | [タスクタイトル] | TODO | - | Xmin | [詳細](phase-1/TASK-001.md) @phase-1/TASK-001.md |
| TASK-002 | [タスクタイトル] | TODO | TASK-001 | Xmin | [詳細](phase-1/TASK-002.md) @phase-1/TASK-002.md |
...
| タスクID | タイトル | ステータス | 依存 | 見積 | 詳細リンク |
|----------|---------|-----------|------|------|-----------|
| TASK-003 | [タスクタイトル] | TODO | Phase 1 | Xmin | [詳細](phase-2/TASK-003.md) @phase-2/TASK-003.md |
| TASK-004 | [タスクタイトル] | TODO | TASK-003 | Xmin | [詳細](phase-2/TASK-004.md) @phase-2/TASK-004.md |
...
| タスクID | タイトル | ステータス | 依存 | 見積 | 詳細リンク |
|----------|---------|-----------|------|------|-----------|
| TASK-005 | [タスクタイトル] | TODO | Phase 2 | Xmin | [詳細](phase-3/TASK-005.md) @phase-3/TASK-005.md |
