...
- [概要](#概要)
- [session_state.md の構造](#session_statemd-の構造)
- [session_state.md の更新タイミング](#session_statemd-の更新タイミング)
- [レジュームフロー](#レジュームフロー)
- [agent_id が無効な場合のフォールバック](#agent_id-が無効な場合のフォールバック)
- [レジューム時の整合性チェック](#レジューム時の整合性チェック)
- [レジューム時のユーザーへの報告](#レジューム時のユーザーへの報告)
<!-- /TOC -->
