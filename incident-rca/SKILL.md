...
**保存場所**:
- `incident-rca/sessions/[YYYY-MM-DD]-[incident-name]/result.md`
...
**保存場所**:
- `incident-rca/sessions/[YYYY-MM-DD]-[incident-name]/log.md`
...
1. **セッションディレクトリの作成**
   ```
   mkdir -p incident-rca/sessions/[YYYY-MM-DD]-[incident-name]
   ```
