...
├── README.md
├── templates/
│   ├── result_template.md    # 分析結果のテンプレート
│   └── log_template.md        # 会話ログのテンプレート
└── sessions/
...
1. **分析開始時**: セッションディレクトリを作成し、log.mdの記録を開始
2. **分析進行中**: すべての会話をlog.mdにリアルタイムで記録
3. **分析完了時**: result.mdを作成し、最終的なマインドツリーと根本原因、再発防止策を記録
