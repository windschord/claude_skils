...
todos = [
  ...
  // --- SDDタスク ---
  { content: "[Phase-1/TASK-001] 完了タスク", status: "completed", activeForm: "..." },
  { content: "[Phase-1/TASK-002] 実行中タスク", status: "in_progress", activeForm: "..." },
  { content: "[Phase-2/TASK-003] 未着手タスク", status: "pending", activeForm: "..." },
  ...
]
```
