...
3b. 各チームメンバーにタスクを割り当て
    - 各メンバーのスポーンプロンプトにタスクファイルパス・対象ファイル・技術コンテキストを含める
   ↓
3c. チームメンバーが独立して実装（各自のステップ4-9を実行）
   ↓
3d. リーダーが全メンバーの完了を待機
   ↓
3e. リーダーがdocs/tasks/index.mdを一括更新
   ↓
3f. リーダーがTodoWriteを一括更新
   ↓
3g. 逆順レビュー → 次の依存グループへ（または完了）
```
