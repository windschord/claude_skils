...
| # | API | 取得対象 | エンドポイント |
|---|-----|---------|--------------|
| 1 | Pull Request Comments | インラインコメント（コード行に紐づくスレッド） | `GET /repos/{owner}/{repo}/pulls/{id}/comments` |
| 2 | Pull Request Reviews | レビュー全体（APPROVED/CHANGES_REQUESTED/COMMENTED + body） | `GET /repos/{owner}/{repo}/pulls/{id}/reviews` |
| 3 | Issue Comments | PR全体へのコメント（レビュー外） | `GET /repos/{owner}/{repo}/issues/{id}/comments` |
