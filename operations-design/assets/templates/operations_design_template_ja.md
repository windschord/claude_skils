...
運用設計で採用するフレームワークとベストプラクティスを記載します。
...
競合サービスの運用品質や特徴を記載します（該当する場合）。

| 競合サービス | 運用品質の特徴 | 本サービスとの差別化 |
|--------------|----------------|----------------------|
| [サービス名] | [特徴] | [差別化ポイント] |
...
| 指標名 | 目標値 | 測定方法 | 測定頻度 |
|--------|--------|----------|----------|
| 可用性（Availability） | [例: 99.9%] | [測定方法] | [頻度] |
| レスポンスタイム | [例: 500ms以下] | [測定方法] | [頻度] |
| エラーレート | [例: 0.1%以下] | [測定方法] | [頻度] |
| MTTR（平均復旧時間） | [例: 30分以内] | [測定方法] | [頻度] |
...
| 監視対象 | 監視項目 | 閾値 | 監視間隔 | アラートレベル |
|----------|----------|------|----------|----------------|
| Webサーバー | CPU使用率 | 80%超 | 1分 | Warning |
| Webサーバー | CPU使用率 | 90%超 | 1分 | Critical |
| Webサーバー | メモリ使用率 | [閾値] | [間隔] | [レベル] |
| データベース | 接続数 | [閾値] | [間隔] | [レベル] |
| アプリケーション | エラーレート | [閾値] | [間隔] | [レベル] |
| アプリケーション | レスポンスタイム | [閾値] | [間隔] | [レベル] |
