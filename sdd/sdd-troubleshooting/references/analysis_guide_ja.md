...
- [分析の原則](#分析の原則)
  - [1. 事実に基づく分析](#1-事実に基づく分析)
  - [2. 仕様との照合](#2-仕様との照合)
  - [3. 承認プロセスの遵守](#3-承認プロセスの遵守)
- [問題分類](#問題分類)
  - [カテゴリ1: 実装バグ](#カテゴリ1-実装バグ)
  - [カテゴリ2: 仕様バグ](#カテゴリ2-仕様バグ)
  - [カテゴリ3: 仕様漏れ](#カテゴリ3-仕様漏れ)
- [原因分析テクニック](#原因分析テクニック)
  - [1. スタックトレース分析](#1-スタックトレース分析)
  - [2. バイナリサーチ](#2-バイナリサーチ)
  - [3. 差分分析](#3-差分分析)
  - [4. コードフロー追跡](#4-コードフロー追跡)
- [影響範囲の評価](#影響範囲の評価)
  - [直接的な影響](#直接的な影響)
  - [間接的な影響](#間接的な影響)
  - [評価マトリクス](#評価マトリクス)
- [修正方針の策定](#修正方針の策定)
  - [アプローチの比較](#アプローチの比較)
  - [推奨アプローチの選定基準](#推奨アプローチの選定基準)
- [承認プロセスの詳細](#承認プロセスの詳細)
  - [承認が必要な理由](#承認が必要な理由)
  - [承認を求めるタイミング](#承認を求めるタイミング)
  - [承認記録の形式](#承認記録の形式)
- [タスク分割のガイドライン](#タスク分割のガイドライン)
  - [分割の原則](#分割の原則)
  - [タスクの順序付け](#タスクの順序付け)
  - [タスク間の依存関係](#タスク間の依存関係)
- [チェックリスト](#チェックリスト)
  - [問題事象確認のチェックリスト](#問題事象確認のチェックリスト)
  - [原因分析のチェックリスト](#原因分析のチェックリスト)
  - [仕様照合のチェックリスト](#仕様照合のチェックリスト)
  - [修正方針策定のチェックリスト](#修正方針策定のチェックリスト)
  - [承認プロセスのチェックリスト](#承認プロセスのチェックリスト)
  - [タスク分割のチェックリスト](#タスク分割のチェックリスト)
<!-- /TOC -->
...
- [ ] 各タスクに受入基準がある
- [ ] 依存関係が明確である
- [ ] タスクを起票した（デフォルト: GitHub Issue `sdd:task`+`sdd:bugfix` / オプション: docs/sdd/tasks/に追加＋index.md更新）
