...
| チェック項目 | 比較対象 |
|-------------|---------|
| エンドポイント | docs/sdd/design/api/*.md vs 実装コード |
...
| チェック項目 | 比較対象 |
|-------------|---------|
| テーブル定義 | docs/sdd/design/database/*.md vs マイグレーション/スキーマ |
...
| チェック項目 | 比較対象 |
|-------------|---------|
| インターフェース | docs/sdd/design/components/*.md vs 実装 |
...
```text
1. docs/sdd/design/api/ のAPI定義を抽出
