...
大規模システムリプレース・移行プロジェクトについて、マルチベンダー管理とリスクマネジメントに長けたPMOの視点で、見落とされがちな潜在リスクを洗い出すスキルです。正常系の設計や特定ベンダーの担当範囲内には現れにくい「ベンダー間の隙間」「業務影響」「異常系」の死角を、フェーズ別の3つの分析フレームワーク（各4視点、カスタム指定も可）で特定します。
