---
name: depth-interview-product
description: サービス開発のためのデプスインタビューを実施します。ユーザーの表面的な回答ではなく、真のニーズ・課題・動機を引き出し、すべての会話をファイルに記録します。5 Whys、ラダリング法などの手法を用いて、プロダクト開発に活かせるインサイトを発見します。
---
